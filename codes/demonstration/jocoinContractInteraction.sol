...
contract Data {
    // Variaveis de inicializacao de um Erc20
    string private name;
    string private symbol; 
    uint256 private totalSupply;

    // Funcao chamada junto com o deploy do contrato
    ...
    // Funcoes 'get' para obter as variaveis
...
contract jocoinErc20 {
    ...
    constructor(address _DataContract) {
        Data data = Data(_DataContract);
        _name = data.getName();
        _symbol = data.getSymbol();
        _totalSupply = data.getTotalSupply();
    }
